...
"C:\Program Files\Git\cmd\git.exe" config user.email "257025742+trevor-foundit@users.noreply.github.com"
"C:\Program Files\Git\cmd\git.exe" config user.name "trevor-foundit"
