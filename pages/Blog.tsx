...
const Blog: React.FC = () => {
  return (
    <div className="pt-20 pb-16 min-h-screen bg-slate-50">
      <Helmet>
        <title>Blog | Guardian Insurance Group</title>
        <meta name="description" content="Stay updated with the latest news, tips, and insights from Guardian Insurance Group." />
      </Helmet>

      {/* Hero Section */}
      <Section className="bg-brand-navy relative overflow-hidden text-white min-h-[40vh] flex items-center">
        <div className="absolute inset-0">
          <img src="/GIGoffice.png" alt="Guardian Insurance Group Office" className="w-full h-full object-cover object-[center_25%] opacity-30" />
        </div>
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4 mt-8">
          ...
          <TextReveal delay={0.2} className="text-xl text-slate-300 justify-center">
            Insights, tips, and news to help you protect what matters most.
          </TextReveal>
        </div>
      </Section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {ARTICLES.map((article, index) => (
              ...
              >
                {/* Image Placeholder (Can be updated once images arrive) */}
                ...
                <div className="p-6 flex flex-col flex-grow">
                  ...
                  <Link to={`/blog/${article.slug}`} className="text-brand-gold font-bold text-sm uppercase tracking-wide flex items-center gap-2 hover:gap-3 transition-all mt-auto self-start">
                    Read More 
