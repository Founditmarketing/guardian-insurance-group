...
const CommunityPost: React.FC = () => {
  ...
  return (
    <div className="pt-20 pb-16 min-h-screen bg-slate-50">
      <Helmet>
        <title>{post.title} | Community Involvement | Guardian Insurance Group</title>
      ...
      <Section className="py-16">
        <div className="max-w-5xl mx-auto px-6">
          <Link to="/community-involvement" className="inline-flex items-center gap-2 text-brand-gold hover:text-brand-goldHover font-bold mb-12 transition-colors">
            <ArrowLeft size={20} />
            Back to Community
          </Link>

          <div className="px-4 md:px-0">
            <div className="text-slate-700 leading-relaxed space-y-6 text-lg md:text-xl mb-12">
              {post.content.split('\n\n').map((paragraph, idx) => {
